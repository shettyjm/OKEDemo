...
## Transfer your API to the team
Choose the settings menu for your API from the top-menu.  Choose *Transfer to Oracle APIP CS*  This will allow the API design to be linked to the implementation in a later lab.
